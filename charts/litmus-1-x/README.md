...
![Version: 1.17.0](https://img.shields.io/badge/Version-1.17.0-informational?style=flat-square) ![AppVersion: 2.0.0](https://img.shields.io/badge/AppVersion-2.0.0-informational?style=flat-square)
...
| exporter.image.tag | string | `"2.0.0"` |  |
...
| operator.image.tag | string | `"2.0.0"` |  |
