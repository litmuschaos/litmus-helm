...
![Version: 2.0.18-Beta4](https://img.shields.io/badge/Version-2.0.18--Beta4-informational?style=flat-square) ![AppVersion: 2.0.0](https://img.shields.io/badge/AppVersion-2.0.0-informational?style=flat-square)
...
| route.host | string | `""` |  |
| route.name | string | `"litmus-portal"` |  |
