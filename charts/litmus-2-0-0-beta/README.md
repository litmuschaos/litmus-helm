...
![Version: 2.0.7-Beta2](https://img.shields.io/badge/Version-2.0.7--Beta2-informational?style=flat-square) ![AppVersion: 2.0.0](https://img.shields.io/badge/AppVersion-2.0.0-informational?style=flat-square)
...
| portal.frontend.image.tag | string | `"2.0.0-Beta2"` |  |
...
| portal.server.authServer.image.tag | string | `"2.0.0-Beta2"` |  |
...
| portal.server.graphqlServer.env.EVENT_TRACKER_IMAGE | string | `"litmuschaos/litmusportal-event-tracker:2.0.0-Beta2"` |  |
...
| portal.server.graphqlServer.env.SUBSCRIBER_IMAGE | string | `"litmuschaos/litmusportal-subscriber:2.0.0-Beta2"` |  |
...
| portal.server.graphqlServer.image.tag | string | `"2.0.0-Beta2"` |  |
