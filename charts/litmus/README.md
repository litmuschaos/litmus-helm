...
| adminConfig.VERSION | string | `"2.5.0"` |  |
...
| portal.frontend.image.tag | string | `"2.5.0"` |  |
...
| portal.server.authServer.image.tag | string | `"2.5.0"` |  |
...
| portal.server.graphqlServer.genericEnv.HUB_BRANCH_NAME | string | `"v2.4.x"` |  |
...
| portal.server.graphqlServer.image.tag | string | `"2.5.0"` |  |
...
| portal.server.graphqlServer.imageEnv.EVENT_TRACKER_IMAGE | string | `"litmusportal-event-tracker:2.5.0"` |  |
| portal.server.graphqlServer.imageEnv.LITMUS_CHAOS_EXPORTER_IMAGE | string | `"chaos-exporter:2.4.0"` |  |
| portal.server.graphqlServer.imageEnv.LITMUS_CHAOS_OPERATOR_IMAGE | string | `"chaos-operator:2.4.0"` |  |
| portal.server.graphqlServer.imageEnv.LITMUS_CHAOS_RUNNER_IMAGE | string | `"chaos-runner:2.4.0"` |  |
| portal.server.graphqlServer.imageEnv.SUBSCRIBER_IMAGE | string | `"litmusportal-subscriber:2.5.0"` |  |
