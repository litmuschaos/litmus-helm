...
| adminConfig.VERSION | string | `"3.9.0"` |  |
...
| portal.frontend.image.tag | string | `"3.9.0"` |  |
...
| portal.server.authServer.image.tag | string | `"3.9.0"` |  |
...
| portal.server.graphqlServer.image.tag | string | `"3.9.0"` |  |
...
| portal.server.graphqlServer.imageEnv.EVENT_TRACKER_IMAGE | string | `"litmusportal-event-tracker:3.9.0"` |  |
...
| portal.server.graphqlServer.imageEnv.SUBSCRIBER_IMAGE | string | `"litmusportal-subscriber:3.9.0"` |  |
