...
![Version: 3.30.0](https://img.shields.io/badge/Version-3.30.0-informational?style=flat-square) ![AppVersion: 3.30.0](https://img.shields.io/badge/AppVersion-3.30.0-informational?style=flat-square)
...
| adminConfig.VERSION | string | `"3.30.0"` |  |
| allowedOrigins | string | `".*"` |  |
| customLabels | object | `{}` | Additional labels |
| customPodAnnotations | object | `{}` | Additional annotations |
| dexServer.affinity | object | `{}` |  |
| dexServer.autoscaling.enabled | bool | `false` |  |
| dexServer.callbackURL | string | `"http://localhost:8080/auth/dex/callback"` |  |
| dexServer.connectors | list | `[]` |  |
| dexServer.containerPort | int | `5556` |  |
| dexServer.customLabels | object | `{}` |  |
| dexServer.enabled | bool | `false` |  |
| dexServer.image.pullPolicy | string | `"IfNotPresent"` |  |
| dexServer.image.repository | string | `"litmuschaos/litmusportal-dex-server"` |  |
| dexServer.image.tag | string | `"ci"` |  |
| dexServer.issuer | string | `"http://<Your Domain>:32000"` |  |
| dexServer.nodeSelector | object | `{}` |  |
| dexServer.replicas | int | `1` |  |
| dexServer.resources | object | `{}` |  |
| dexServer.secret | string | `"ZXhhbXBsZS1hcHAtc2VjcmV0"` |  |
| dexServer.securityContext | object | `{}` |  |
| dexServer.service.annotations | object | `{}` |  |
| dexServer.service.nodePort | int | `32000` |  |
| dexServer.service.port | int | `5556` |  |
| dexServer.service.targetPort | int | `5556` |  |
| dexServer.service.type | string | `"NodePort"` |  |
| dexServer.tolerations | list | `[]` |  |
| dexServer.updateStrategy | object | `{}` |  |
...
| nameOverride | string | `""` |  |
| openshift.dexServer.route.annotations | object | `{}` |  |
| openshift.dexServer.route.customLabels | object | `{}` |  |
| openshift.dexServer.route.enabled | bool | `false` |  |
...
| portal.frontend.image.tag | string | `"3.30.0"` |  |
...
| portal.server.authServer.image.tag | string | `"3.30.0"` |  |
...
| portal.server.graphqlServer.genericEnv.DEFAULT_HUB_BRANCH_NAME | string | `"v3.30.x"` |  |
| portal.server.graphqlServer.genericEnv.ENABLE_GQL_INTROSPECTION | string | `"false"` |  |
| portal.server.graphqlServer.genericEnv.INFRA_COMPATIBLE_VERSIONS | string | `"[\"3.30.0\"]"` |  |
...
| portal.server.graphqlServer.genericEnv.WORKFLOW_HELPER_IMAGE_VERSION | string | `"3.30.0"` |  |
...
| portal.server.graphqlServer.image.tag | string | `"3.30.0"` |  |
...
| portal.server.graphqlServer.imageEnv.EVENT_TRACKER_IMAGE | string | `"litmusportal-event-tracker:3.30.0"` |  |
| portal.server.graphqlServer.imageEnv.LITMUS_CHAOS_EXPORTER_IMAGE | string | `"chaos-exporter:3.30.0"` |  |
| portal.server.graphqlServer.imageEnv.LITMUS_CHAOS_OPERATOR_IMAGE | string | `"chaos-operator:3.30.0"` |  |
| portal.server.graphqlServer.imageEnv.LITMUS_CHAOS_RUNNER_IMAGE | string | `"chaos-runner:3.30.0"` |  |
| portal.server.graphqlServer.imageEnv.SUBSCRIBER_IMAGE | string | `"litmusportal-subscriber:3.30.0"` |  |
