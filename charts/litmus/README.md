...
| upgradeAgent.resources.limits.cpu | string | `"100m"` |  |
| upgradeAgent.resources.limits.memory | string | `"128Mi"` |  |
| upgradeAgent.resources.requests.cpu | string | `"100m"` |  |
| upgradeAgent.resources.requests.memory | string | `"128Mi"` |  |
