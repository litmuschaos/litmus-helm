...
![Version: 2.26.0](https://img.shields.io/badge/Version-2.26.0-informational?style=flat-square) ![AppVersion: 2.12.0](https://img.shields.io/badge/AppVersion-2.12.0-informational?style=flat-square)
...
| image.litmus.tag | string | `"2.12.0"` |  |
...
| image.litmusLIBImage.tag | string | `"2.12.0"` |  |
