...
![Version: 3.7.1](https://img.shields.io/badge/Version-3.7.1-informational?style=flat-square) ![AppVersion: 3.7.0](https://img.shields.io/badge/AppVersion-3.7.0-informational?style=flat-square)
...
| exporter.image.tag | string | `"3.7.0"` |  |
...
| operator.image.tag | string | `"3.7.0"` |  |
