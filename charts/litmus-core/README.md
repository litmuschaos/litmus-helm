...
![Version: 3.31.1](https://img.shields.io/badge/Version-3.31.1-informational?style=flat-square) ![AppVersion: 3.31.0](https://img.shields.io/badge/AppVersion-3.31.0-informational?style=flat-square)
...
| exporter.image.tag | string | `"3.31.0"` |  |
...
| operator.image.tag | string | `"3.31.0"` |  |
...
| runner.image.tag | string | `"3.31.0"` |  |
| service.port | int | `80` |  |
